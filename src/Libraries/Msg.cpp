...
void Msg::help(){
	...
	std::cout << "	  Returns system time according to settings in config file." << std::endl;
	std::cout << "	  Options can be added to manipulate output as shown:" << std::endl;
	...
	std::cout << "	  At the end of a command, " << std::endl;
	std::cout << "	  a positive integer can be entered as the timer or stopwatch time." << std::endl;
...
void Msg::version(){
	std::cout << "intervalcli 2.3.0" << std::endl
	<< "Date Originally Published: 8-17-24" << std::endl
	<< "Date of most recent update: 10-2-24" << std::endl
